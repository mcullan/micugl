...
declare global {
    interface Window {
        __glCounters: GlCounters;
        __frameSampler: FrameSampler;
    }
}
...
export function installInstrumentation(): void {
    ...
    const glProto = WebGLRenderingContext.prototype as unknown as Record<string, GlProtoMethod>;
    ...
    const canvasProto = HTMLCanvasElement.prototype as unknown as Record<string, GetContextMethod>;

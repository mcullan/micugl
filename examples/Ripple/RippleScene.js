...
export const Ripple = ({ damping = 0.99, mouseForce = 0.5, color1 = COLOR_1, color2 = COLOR_2, iterations = 2, className = '', style }) => {
    ...
    return (_jsx(BasePingPongShaderComponent, { programId: 'ripple-simulation', shaderConfig: simulationShaderConfig, secondaryProgramId: 'ripple-render', secondaryShaderConfig: renderShaderConfig, iterations: iterations, className: className, style: style, framebufferOptions: {
            width: 0,
            height: 0,
            textureCount: 2,
            textureOptions: {
...
//# sourceMappingURL=RippleScene.js.map